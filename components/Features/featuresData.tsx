...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "With our responsive web design expertise, your website will adapt effortlessly to any screen size or device, providing users with a seamless experience whether they're browsing on a desktop, tablet, or smartphone. Reach your audience wherever they are and leave a lasting impression with a website that looks stunning on every platform.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Unlock the full potential of your online presence with our advanced SEO optimization services. Our team of experts will analyze your website, implement strategic keywords, and optimize every aspect to improve your search engine ranking. Stay ahead of the competition and drive organic traffic to your site with our tailored SEO solutions.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Bring your ideas to life with our cutting-edge app development services. Whether you're looking to create a user-friendly mobile app or a robust web application, our team has the expertise to deliver innovative solutions tailored to your unique requirements. From concept to launch, we ensure a seamless experience for both you and your users.",
  },
];
